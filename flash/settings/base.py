...
# Email Configuration
# Configuración de Email - Producción usa SMTP, desarrollo usa console
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', f'Flash Marketplace <{EMAIL_HOST_USER}>')
